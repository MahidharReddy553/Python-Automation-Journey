...
* Report Attachment: During test failures, the pytest\_runtest\_makereport hook in conftest.py automatically reads automation.log and attaches the log content directly to the corresponding Allure failure report.
...
* Test Failure Event: When Pytest executes a test, the custom pytest\_runtest\_makereport hook monitors the execution phase outcome (call.when == "call").
